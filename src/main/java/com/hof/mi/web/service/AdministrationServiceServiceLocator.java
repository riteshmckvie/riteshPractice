...
public class AdministrationServiceServiceLocator extends org.apache.axis.client.Service implements com.hof.mi.web.service.AdministrationServiceService {
    ...
    private java.lang.String AdministrationService_address = "https://devreporting.healthipass.com/services/AdministrationService";
    ...
    public com.hof.mi.web.service.AdministrationService getAdministrationService() throws javax.xml.rpc.ServiceException {
    ...
    public com.hof.mi.web.service.AdministrationService getAdministrationService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.hof.mi.web.service.AdministrationServiceSoapBindingStub _stub = new com.hof.mi.web.service.AdministrationServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.hof.mi.web.service.AdministrationService.class.isAssignableFrom(serviceEndpointInterface)) {
                com.hof.mi.web.service.AdministrationServiceSoapBindingStub _stub = new com.hof.mi.web.service.AdministrationServiceSoapBindingStub(new java.net.URL(AdministrationService_address), this);
                _stub.setPortName(getAdministrationServiceWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://service.web.mi.hof.com", "AdministrationServiceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://service.web.mi.hof.com", "AdministrationService"));
        }
